      ...
      <div className="bg-white w-full max-w-6xl rounded-[2rem] shadow-2xl flex flex-col max-h-[98vh] border overflow-hidden">
        ...
        <div className="p-4 border-b bg-slate-50/80 justify-center">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className="text-xs font-black text-emerald-600 uppercase tracking-[0.2em]">{datos.subsidiaria}</span>
                <select
                  className={`text-sm font-black uppercase tracking-widest border px-2 py-0.5 rounded-md outline-none cursor-pointer ${esVistaHistorica ? 'bg-rose-100 text-rose-600 border-rose-200' : 'bg-slate-200 text-slate-700 border-slate-300'}`}
                ...
                {datos.codigoCalidadPropio && (
                  <span className="text-sm font-black text-white uppercase tracking-widest bg-emerald-600 px-2 py-0.5 rounded-md flex items-center gap-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              <label className="text-sm font-black text-slate-600 uppercase">Elaborado por</label>
              <input list="personal" disabled={esSoloLectura} className="w-full p-1.5 border rounded-lg text-sm font-bold" value={datos.elaboradoPor} onChange={(e: { target: { value: any; }; }) => setDatos({ ...datos, elaboradoPor: e.target.value })} />
            </div>
            <div className="space-y-1">
              <label className="text-sm font-black text-slate-600 uppercase">Aprobado por</label>
              <input list="personal" disabled={esSoloLectura} className="w-full p-1.5 border rounded-lg text-sm font-bold" value={datos.aprobadoPor} onChange={(e: { target: { value: any; }; }) => setDatos({ ...datos, aprobadoPor: e.target.value })} />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              <label className="text-sm font-black text-slate-600 uppercase">Área Produce</label>
              <input list="areas-p" disabled={esSoloLectura} className="w-full p-1.5 border rounded-lg text-sm font-bold" value={datos.areaProduce} onChange={(e: { target: { value: any; }; }) => setDatos({ ...datos, areaProduce: e.target.value })} />
            </div>
            <div className="space-y-1">
              <label className="text-sm font-black text-slate-600 uppercase">Área Empaca</label>
              <input list="areas-e" disabled={esSoloLectura} className="w-full p-1.5 border rounded-lg text-sm font-bold" value={datos.areaEmpaca} onChange={(e: { target: { value: any; }; }) => setDatos({ ...datos, areaEmpaca: e.target.value })} />
            </div>
        ...
        <div className="flex border-b bg-white px-6 space-x-8">
          {[
            ...
            <button key={t.id} onClick={() => setTab(t.id as any)} className={`py-3 flex items-center gap-2 text-xs font-black uppercase tracking-widest border-b-4 transition-all ${tab === t.id ? 'border-emerald-600 text-emerald-600' : 'border-transparent text-slate-700'}`}>
            ...
            <div className="space-y-6 animate-in fade-in">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="md:col-span-2">
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Especificación de producto terminado</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-3">
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Descripción Técnica del producto</label>
                ...
                <div className="md:col-span-3">
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Declaración de ingredientes (Para Etiqueta)</label>
                ...
                <div className="md:col-span-3">
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Ingredientes</label>
                ...
                <div className="md:col-span-3">
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Alérgenos (separados por coma)</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Uso Intencional del producto</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Consumidor Objetivo y Restricciones</label>
                  ...
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Restricciones</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Empaque</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Almacenamiento Interno y manejo del producto</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Transporte</label>
                ...
                <div className="md:col-span-1">
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Aspectos de Rechazo</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Almacenamiento en Punto de Venta</label>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <label htmlFor="labelreq" className="text-xs font-black uppercase text-emerald-600">Requiere etiqueta con declaración de ingredientes</label>
                </div>
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Vida Útil Congelado</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Vida Útil Refrigerado</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Vida Útil Ambiente</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Registro M.S.</label>
                ...
                <div>
                  <label className="text-xs font-black text-slate-600 uppercase block mb-1">Código de Barras</label>
              ...
              <div className="p-4 bg-emerald-50/50 rounded-2xl border border-emerald-100 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="lg:col-span-4 space-y-2">
                  <label className="text-xs font-black text-emerald-900 uppercase">Configuración de Pesos (g/kg)</label>
          ...
          {tab === 'fisicoquimica' && (
            <><div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={f.k}>
                  <label className={`text-xs font-black uppercase block mb-1 ${f.qc ? 'text-emerald-600' : 'text-slate-600'}`}>{f.l}</label>
                ...
                {[
                  ...
                  <div key={f.k} className="p-4 bg-emerald-50/20 border border-emerald-100 rounded-2xl space-y-3">
                    <label className="text-sm font-black text-emerald-600 uppercase tracking-widest block">{f.l}</label>
                    <div className="grid grid-cols-3 gap-2">
                      <div className="space-y-1">
                        <label className="text-sm font-black text-slate-600 uppercase text-center block">Min</label>
                      ...
                      <div className="space-y-1">
                        <label className="text-sm font-black text-emerald-600 uppercase text-center block">Target</label>
                      ...
                      <div className="space-y-1">
                        <label className="text-sm font-black text-slate-600 uppercase text-center block">Max</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {['color', 'sabor', 'textura', 'olor'].map(o => (
                    <div key={o}>
                      <label className="text-xs font-black text-slate-600 uppercase block mb-1">{o}</label>
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <label className="aspect-square rounded-xl border-2 border-dashed border-slate-100 flex flex-col items-center justify-center gap-1 cursor-pointer hover:border-emerald-200 text-slate-700 transition-all">
                    <Camera className="w-8 h-8" />
                    <span className="text-sm font-black uppercase">Subir</span>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-xl font-black text-sm uppercase border border-emerald-100 transition disabled:opacity-50"
                  >
                    <ClipboardList className="w-3.5 h-3.5" /> Pre-cargar
                  </button>
                  <button onClick={agregarMicro} disabled={esSoloLectura} className="flex items-center gap-1.5 bg-slate-900 text-white px-3 py-1.5 rounded-xl font-black text-sm uppercase hover:bg-slate-800 transition disabled:opacity-50"><Plus className="w-3.5 h-3.5" /> Agregar</button>
                </div>
              </div>
              <div className="border rounded-2xl overflow-hidden shadow-sm">
                <table className="w-full text-left text-sm">
                  <thead className="bg-slate-900 text-slate-600 font-bold uppercase tracking-wider">
                    ...
                    {datos.aspectosMicrobiologicos.map((m: { microorganismo: any; detalle: any; }, i: number) => (
                      <tr key={i} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-4 py-1.5 text-center">
                          <button disabled={esSoloLectura} onClick={() => { const nuevos = datos.aspectosMicrobiologicos.filter((_: any, idx: any) => idx !== i); setDatos({ ...datos, aspectosMicrobiologicos: nuevos }); }} className="p-1 px-2 text-slate-700 hover:text-rose-500 transition-colors disabled:opacity-50"><Trash2 className="w-4 h-4" /></button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-in fade-in">
              <div className="space-y-4">
                ...
                <div className="p-4 bg-slate-900 rounded-2xl border space-y-3">
                  <label className="text-sm font-black text-emerald-300 uppercase tracking-widest block">Certificación Final</label>
                  <div className="flex gap-2">
              ...
              <div className="space-y-4">
                ...
                {datos.historialCambios && datos.historialCambios.length > 0 ? (
                  <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2">
                    {datos.historialCambios.slice().reverse().map((cambio: any, i: number) => (
                      <div key={i} className="p-3 bg-slate-50 border rounded-xl flex flex-col gap-1">
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-black text-slate-700 uppercase tracking-widest">Versión {cambio.version}</span>
                          <span className="text-xs font-bold text-slate-600">{cambio.fecha}</span>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                          ...
                          <span className="text-xs font-bold text-slate-700">{cambio.usuario}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="p-6 bg-slate-50 border border-dashed rounded-2xl flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-xs font-bold text-slate-700">No hay registros de cambios previos.</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="p-4 border-t bg-slate-50/80 flex justify-between items-center rounded-b-[2rem]">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-white border flex items-center justify-center font-black text-sm">v{datos.version}</div>
            <div>
              <p className="text-sm font-black text-slate-600 uppercase tracking-widest leading-none">Última Modificación</p>
              <p className="text-sm font-bold text-slate-700 italic mt-0.5">{datos.ultimaModificacion}</p>
            </div>
          </div>
          <div className="flex gap-2">
            <button onClick={onClose} className="px-6 py-2 bg-white border text-slate-600 font-black uppercase text-sm rounded-xl shadow-sm hover:bg-slate-50">Cerrar</button>
            {!esSoloLectura && (
              <>
                <button onClick={() => handleGuardar()} className="px-6 py-2 bg-slate-200 text-slate-700 font-black uppercase text-sm rounded-xl hover:bg-slate-300">Guardar Avance</button>
                <button onClick={() => handleGuardar(true)} className="px-8 py-2 bg-emerald-600 text-white font-black uppercase text-sm rounded-xl shadow-lg hover:bg-emerald-700 flex items-center gap-2">
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <header className="flex justify-between items-end">
        ...
        {(role === 'CHEF' || role === 'ADMIN') && (
          <button onClick={onCreate} className="flex items-center gap-2 bg-emerald-600 text-white px-5 py-2.5 rounded-xl font-black uppercase text-sm tracking-widest shadow-lg hover:bg-emerald-700 transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtradas.map(f => (
          <div key={f.id} className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 group hover:shadow-xl transition-all flex flex-col relative overflow-hidden">
            ...
            <p className="text-sm font-black text-emerald-600 uppercase tracking-widest mb-3">{f.subsidiaria}</p>
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-500">
      <header>
        ...
        <p className="text-slate-700 font-medium text-sm mt-1 italic uppercase tracking-wider">Perfil: <span className="text-emerald-600 font-black">{role}</span></p>
      </header>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        {estadisticas.map((stat, i) => (
          <div key={i} onClick={() => setView(stat.vista)} className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4 group hover:shadow-lg transition-all cursor-pointer hover:scale-[1.02] active:scale-95">
            ...
            <div>
              <p className="text-xs font-black text-slate-600 uppercase tracking-widest">{stat.label}</p>
