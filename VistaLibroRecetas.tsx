    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <header className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-4">
        <div>
          ...
          <p className="text-slate-700 font-medium text-sm mt-1 italic">Versiones finales aprobadas.</p>
        </div>
                  ...
                  <tr key={r.id} onClick={() => onSelect(r)} className="hover:bg-slate-50/50 transition-colors cursor-pointer group">
                    <td className="px-6 py-3">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-xs font-bold text-slate-600 uppercase">{r.areaProduce || 'Sin Área'}</span>
